...
public class BooleanValueDeserializerTest {
  ...
  public void testFullEntityDeserialization() throws IOException {
    final String fixutre = "{\"test-key-true\": true, \"test-key-false\": false}";
    final FullEntity fullEntity = json.readValue(fixutre, FullEntity.class);
    assertThat(fullEntity.getValue("test-key-true").get(), is(true));
    assertThat(fullEntity.getValue("test-key-false").get(), is(false));
  }
  ...
  public void testMapDeserialization() throws IOException {
    ...
    assertThat(valueMap.get("test-key-true").get(), is(true));
    assertThat(valueMap.get("test-key-false").get(), is(false));
  }

  @Test
  public void testListTypeRefernceDeserialization() throws IOException {
    final String fixutre = "[true, false]";
    ...
    assertThat(list.contains(BooleanValue.of(true)), is(true));
    assertThat(list.contains(BooleanValue.of(false)), is(true));
  }
  ...
  public void testListValueDeserialization() throws IOException {
    ...
    assertThat(listValue.get().contains(BooleanValue.of(true)), is(true));
    assertThat(listValue.get().contains(BooleanValue.of(false)), is(true));
  }
}
