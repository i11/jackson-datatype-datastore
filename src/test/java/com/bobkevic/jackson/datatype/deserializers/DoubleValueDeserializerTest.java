...
public class DoubleValueDeserializerTest {
  ...
  public void testFullEntityDeserialization() throws IOException {
    final String fixutre = "{\"test-key-1\": 0.1, \"test-key-2\": 0.2}";
    final FullEntity fullEntity = json.readValue(fixutre, FullEntity.class);
    assertThat(fullEntity.getValue("test-key-1").get(), is(0.1D));
    assertThat(fullEntity.getValue("test-key-2").get(), is(0.2D));
  }
  ...
  public void testMapDeserialization() throws IOException {
    ...
    assertThat(valueMap.get("test-key-1").get(), is(0.1D));
    assertThat(valueMap.get("test-key-2").get(), is(0.2D));
  }

  @Test
  public void testListTypeRefernceDeserialization() throws IOException {
    final String fixutre = "[0.1, 0.2]";
    ...
    assertThat(list.contains(DoubleValue.of(0.1)), is(true));
    assertThat(list.contains(DoubleValue.of(0.2)), is(true));
  }
